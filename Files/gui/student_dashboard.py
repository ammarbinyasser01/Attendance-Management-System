...
# ==========================================
# COLOR / FONT PALETTE (matches Teacher Dashboard)
# ==========================================
...
class StudentDashboard(ctk.CTk):
    ...
    def __init__(self, username):
        ...
        title = ctk.CTkLabel(
            title_frame,
            text="\U0001F393  Student Dashboard",
        ...
        welcome.pack(anchor="w", pady=(2, 0))
        ...
        self.tabs.add(self.course_tab, text="  \U0001F4D6  Course  ")
        self.tabs.add(self.attendance_tab, text="  \U0001F4CB  Attendance  ")
        self.tabs.add(self.feedback_tab, text="  \U0001F4AC  User Feedback  ")
        ...
        self.course_table.heading("sr", text="Sr No")
        self.course_table.heading("course", text="Course Name")
        self.course_table.heading("instructor", text="Instructor")
        self.course_table.heading("email", text="Instructor Email")
        ...
        self.student_attendance = StudentAttendance(
            attendance_card,
            self.username
        )
        self.student_attendance.pack(
             fill="both",
             expand=True,
             padx=20,
             pady=(0, 20)
